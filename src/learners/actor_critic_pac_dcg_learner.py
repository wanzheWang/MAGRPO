...
class PACDCGLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        self.state_value_lr_scheduler = build_lr_scheduler(
            self.state_value_optimiser, args
        )
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        if t_env - self.log_stats_t >= self.args.learner_log_interval:
            ...
            self.logger.log_stat(
                "state_value_lr", get_current_lr(self.state_value_optimiser), t_env
            )
            self.logger.log_stat(
                "pi_max",
    ...
    def train_critic_sequential(self, batch, rewards, mask, terminated):
        ...
        step_lr_scheduler(self.state_value_lr_scheduler, loss_v.item())
