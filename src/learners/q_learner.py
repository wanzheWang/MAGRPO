...
class QLearner:
    def __init__(self, mac, scheme, logger, args):
        ...
        self.lr_scheduler = build_lr_scheduler(self.optimiser, args)
    ...
    def train(self, batch: EpisodeBatch, t_env: int, episode_num: int):
        ...
        self.optimiser.step()
        step_lr_scheduler(self.lr_scheduler, loss.item())
        ...
        if t_env - self.log_stats_t >= self.args.learner_log_interval:
            ...
            self.logger.log_stat("lr", get_current_lr(self.optimiser), t_env)
